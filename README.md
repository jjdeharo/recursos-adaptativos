...
- Modelo IRT 3PL con análisis del parámetro de discriminación (incluida la discriminación efectiva $a\,(1-c_q)$ para igualar la pendiente máxima entre formatos con distinto azar) y la curva característica del ítem
...
├── CAMBIOS_METODOLOGIA.md                            Registro de cambios metodológicos relevantes
